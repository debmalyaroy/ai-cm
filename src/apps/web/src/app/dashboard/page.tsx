...
// --- Explain & Actions Button (dispatches to chat, opens action modal) ---
function CardOptionsButton({ cardType, cardData, variant = "menu" }: { cardType: string; cardData: object; variant?: "menu" | "inline" }) {
